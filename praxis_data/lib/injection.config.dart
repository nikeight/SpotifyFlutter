...
import 'repositories/song/DataAlbumRepository.dart' as _i21;
...
import 'sources/network/RandomTopAlbumDataSource.dart' as _i19;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt $initGetIt({
    ...
    gh.factory<_i15.CustomApiClient>(
        () => _i15.CustomApiClient(get<_i5.Dio>()));
    gh.factory<_i16.JokesApi>(() => _i16.JokesApi(get<_i10.JokesListMapper>()));
    ...
    gh.factory<_i19.RandomTopAlbumDataSource>(
        () => _i19.RandomTopAlbumDataSource(get<_i15.CustomApiClient>()));
    gh.factory<_i20.SongsRepository>(() => _i21.DataAlbumRepository(
          get<_i19.RandomTopAlbumDataSource>(),
