...
import 'di/injection_dart.dart' as _i19;
import 'mapper/AlbumModellMapper.dart' as _i4;
import 'mapper/ArtistDataDomainMapper.dart' as _i5;
import 'mapper/ItemDataDomainMapper.dart' as _i10;
import 'mapper/TrackDataDomainMapper.dart' as _i12;
import 'repositories/SpotifyHomeRepositoryImpl.dart' as _i18;
import 'sources/local/album_db/album_database.dart' as _i3;
import 'sources/network/common/custom_api_client.dart' as _i13;
import 'sources/network/source/RandomTopAlbumDataSource.dart' as _i14;
import 'sources/network/source/spotify_data_source.dart' as _i15;
import 'sources/network/source/SpotifyDataSourceImpl.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> $initGetIt({
    ...
    gh.factory<_i7.GetMultipleAlbumUseCase>(
        () => useCaseModule.getMultipleAlbumUseCase);
    gh.factory<_i8.GetNewRefreshTokenUseCase>(
        () => useCaseModule.getNewRefreshTokenUseCase);
    gh.factory<_i9.GetTrackListUseCase>(
        () => useCaseModule.getTrackListUseCase);
    gh.factory<_i10.ItemDataDomainMapper>(
        () => _i10.ItemDataDomainMapper(get<_i5.ArtistDataDomainMapper>()));
    await gh.factoryAsync<_i11.SharedPreferences>(
      () => storageModule.sharedPrefs,
      preResolve: true,
    );
    gh.factory<_i12.TrackDataDomainMapper>(
        () => _i12.TrackDataDomainMapper(get<_i10.ItemDataDomainMapper>()));
    gh.factory<_i13.CustomApiClient>(
        () => _i13.CustomApiClient(get<_i6.Dio>()));
    gh.factory<_i14.RandomTopAlbumDataSource>(
        () => _i14.RandomTopAlbumDataSource(get<_i13.CustomApiClient>()));
    gh.factory<_i15.SpotifyDatasource>(() => _i16.SpotifyDataSourceImpl(
          get<_i13.CustomApiClient>(),
          get<_i11.SharedPreferences>(),
        ));
    gh.factory<_i17.SpotifyRepository>(() => _i18.SpotifyHomeRepositoryImpl(
          get<_i15.SpotifyDatasource>(),
          get<_i4.AlbumModelMapper>(),
          get<_i12.TrackDataDomainMapper>(),
        ));
    return this;
  }
}
