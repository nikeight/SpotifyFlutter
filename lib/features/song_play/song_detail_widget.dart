    ...
    return BlocBuilder<AudioPlayerManagerBloc, AudioPlayerManagerBlocState>(
      ...
      return Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Text(state.trackArtistName,
                  textAlign: TextAlign.left,
                  overflow: TextOverflow.fade,
                  style: const TextStyle(color: Colors.black, fontSize: 18)),
              Text(state.trackTitleName,
                  textAlign: TextAlign.left,
                  overflow: TextOverflow.fade,
              ...
              const SizedBox(height: 24),
              Slider(
                min: state.progressBarCurrentValue.toDouble(),
                max: state.progressBarTotalValue.toDouble(),
                activeColor: Colors.white70,
                inactiveColor: Colors.grey,
                thumbColor: Colors.white,
                value: state.progressBarCurrentValue.toDouble(),
                onChanged: (newValue) {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(state.progressBarCurrentValue.toString(),
                        style: const TextStyle(
                            color: Colors.black45,
                            fontSize: 12,
                            fontWeight: FontWeight.bold)),
                    Text(state.progressBarTotalValue.toString(),
                        style: const TextStyle(
                            color: Colors.black45,
                            fontSize: 12,
                            fontWeight: FontWeight.bold)),
              ...
              Row(
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      state.isAudioPlayerLoading
                          ? const CircularProgressIndicator()
                          : state.isAudioPlayerPlaying
                              ? IconButton(
                                  iconSize: 62,
                                  onPressed: () {
                                    context
